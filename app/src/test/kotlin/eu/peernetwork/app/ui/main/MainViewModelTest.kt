...
internal class MainViewModelTest {
    ...
    private val interactor = mockk<AuthenticationInteractor>(relaxed = true)
    ...
    fun setup() {
        ...
        viewModel = MainViewModel(tokenUsecase, tokenObserverUsecase, interactor, subscriptionInteractor)
    }
