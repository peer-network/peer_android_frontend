...
public final class MainModule_ProvideViewModelFactoryFactory implements Factory<ViewModelProvider.Factory> {
  private final Provider<Map<Class<? extends ViewModel>, Provider<ViewModel>>> classToViewModelProvider;

  public MainModule_ProvideViewModelFactoryFactory(
  ...
  public static MainModule_ProvideViewModelFactoryFactory create(
      Provider<Map<Class<? extends ViewModel>, Provider<ViewModel>>> classToViewModelProvider) {
    return new MainModule_ProvideViewModelFactoryFactory(classToViewModelProvider);
  }
  ...
  public static ViewModelProvider.Factory provideViewModelFactory(
    ...
    return Preconditions.checkNotNullFromProvides(MainModule.INSTANCE.provideViewModelFactory(classToViewModel));
  }
}
