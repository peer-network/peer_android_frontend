...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>graphql</b> with <b>com.apollographql.apollo3:apollo-runtime</b> coordinates and
     * with version reference <b>graphql</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
     ...
     * with version reference <b>androidx.lifecyle</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>lifecyle</b> with <b>androidx.lifecycle:lifecycle-runtime-ktx</b> coordinates and
         * with version reference <b>androidx.lifecyle</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getLifecyle() {
            return create("androidx.lifecyle");
        }
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>compose.constraintlayout</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
         ...
         * with version reference <b>compose.livedata</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class MockkLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>mockk</b> with <b>io.mockk:mockk-common</b> coordinates and
        ...
        /**
         * Dependency provider for <b>jvm</b> with <b>io.mockk:mockk-jvm</b> coordinates and
         * with version reference <b>mockk.jvm</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getJvm() {
            return create("mockk.jvm");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>composeAnimation</b> with value <b>1.7.0-alpha07</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>graphql</b> with value <b>3.8.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGraphql() { return getVersion("graphql"); }
        ...
        /**
         * Version alias <b>kover</b> with value <b>0.9.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.lifecyle</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLifecyle() { return getVersion("androidx.lifecyle"); }

        /**
         * Version alias <b>androidx.splash</b> with value <b>1.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>androidx.test</b> with value <b>2.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.constraintlayout</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>compose.livedata</b> with value <b>1.7.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLivedata() { return getVersion("compose.livedata"); }
    ...
    public static class MockkVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>mockk.jvm</b> with value <b>1.13.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJvm() { return getVersion("mockk.jvm"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>graphql</b> with plugin id <b>com.apollographql.apollo3</b> and
         * with version reference <b>graphql</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Plugin provider for <b>parcelise</b> with plugin id <b>kotlin-parcelize</b> and
         * with version reference <b>kotlin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getParcelise() { return createPlugin("parcelise"); }
