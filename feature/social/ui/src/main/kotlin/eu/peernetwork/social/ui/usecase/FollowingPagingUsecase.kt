...
class FollowingPagingUsecase @Inject constructor(
    private val dispatcher: Dispatcher,
    private val usecase: FollowingsUsecase
) : PagingUsecase<FollowingPagingUsecase.Parameter, UiMember>() {
    ...
    override suspend fun getData(params: LoadParams<Int>): LoadResult<Int, UiMember> = withContext(dispatcher.io) {
        ...
        val response = usecase(FollowingsUsecase.Params(param.id, currentPage))
