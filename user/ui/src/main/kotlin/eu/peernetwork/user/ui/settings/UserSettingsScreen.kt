...
fun UserSettingsScreen(
    ...
    val derivedState = remember { derivedStateOf {
        when(state) {
            UserSettingsViewModel.State.Empty -> DesignStatefulContentState.Empty
            UserSettingsViewModel.State.Loading -> DesignStatefulContentState.Loading
            is UserSettingsViewModel.State.Content -> {
                DesignStatefulContentState.Success((state as UserSettingsViewModel.State.Content).account)
            }
            is UserSettingsViewModel.State.Failure -> {
                DesignStatefulContentState.Error((state as UserSettingsViewModel.State.Failure).error)
            }
        }
    } }
