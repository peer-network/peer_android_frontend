...
internal class AccountViewModelTest {
    ...
    fun setup() {
        ...
        viewModel = AccountViewModel(usecase, refreshUsecase, observer)
    }
    ...
    fun `test get authenticated user if not retrieved`() = runTest {
        ...
        viewModel.state.test {
            ...
            assertEquals(AccountViewModel.State.Success(mockData), awaitItem())
        }
    }
    ...
    fun `test get authenticated user error`() = runTest {
        ...
        viewModel.getAccount()
        viewModel.state.test {
            assertEquals(AccountViewModel.State.Error(mockData), awaitItem())
        }
    }
